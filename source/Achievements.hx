...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		['Truly A "H" Difficulty',		"Beat Andrew's Week on Hard with no Misses.",		'week1_nomiss',			false],
		["Spawn Killing",				"Beat Skem's Week on Hard with no Misses.",			'week2_nomiss',			false],
		["Not So Fab Of You",			"Beat Fab's Week on Hard with no Misses.",			'week3_nomiss',			false],
		["Slow Down, Fur-Head!",			"Beat JSona's Week on Hard with no Misses.",		'week4_nomiss',			false],
