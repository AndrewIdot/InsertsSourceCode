...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'anchtrew': //ANDREW FROM FRIDTA  BUGGBT FUYKIUN N
				var bg:BGSprite = new BGSprite('BG WOAH/andrew bg/background', -600, -400, 0.9, 0.9);
				add(bg);

				var groun:BGSprite = new BGSprite('BG WOAH/andrew bg/ground', -600, -400, 0.9, 0.9);
				groun.setGraphicSize(Std.int(groun.width * 1.0));
				groun.updateHitbox();
				add(groun);
				
				var doorst:BGSprite = new BGSprite('BG WOAH/andrew bg/doorstair', -600, -400, 0.9, 0.9);
				doorst.setGraphicSize(Std.int(doorst.width * 1.0));
				doorst.updateHitbox();
				add(doorst);
				
				var crotch:BGSprite = new BGSprite('BG WOAH/andrew bg/couch', -600, -400, 0.9, 0.9); 
				crotch.setGraphicSize(Std.int(crotch.width * 1.0));
				crotch.updateHitbox();
				
				// bet this fucking couch wont be used because of layering again lol
				
				// i was right holy shit
				
				// nevermind
				
			case 'bamber': //bamembert
				var sky:BGSprite = new BGSprite('BG WOAH/bamber/sky', -700, 0, 0.9, 0.9);
				add(sky);
			
				var hills:BGSprite = new BGSprite('BG WOAH/bamber/orangey hills', -250, 200, 0.9, 0.9);
				add(hills);
	
				var farm:BGSprite = new BGSprite('BG WOAH/bamber/funfarmhouse', 150, 250, 0.9, 0.9);
				add(farm);
				
				var foreground:BGSprite = new BGSprite('BG WOAH/bamber/grass lands', -400, 600, 0.9, 0.9);
				add(foreground);
				
				var cornSet:BGSprite = new BGSprite('BG WOAH/bamber/Cornys', -350, 325, 0.9, 0.9);
				add(cornSet);
				
				var cornSet2:BGSprite = new BGSprite('BG WOAH/bamber/Cornys', 1050, 325, 0.9, 0.9);
				add(cornSet2);
				
				var fence:BGSprite = new BGSprite('BG WOAH/bamber/crazy fences', -350, 450, 0.9, 0.9);
				add(fence);
	
				var sign:BGSprite = new BGSprite('BG WOAH/bamber/Sign', 0, 500, 0.9, 0.9);
				add(sign);
				
			case 'fabroom': //WOAH ITS THE GUY
				var city:BGSprite = new BGSprite('BG WOAH/fab/city', -350, -700, 1, 1);
				city.updateHitbox();
				add(city);
				
				var bg:BGSprite = new BGSprite('BG WOAH/fab/house', -350, -700, 1, 1);
				bg.updateHitbox();
				add(bg);
				
			case 'crossroads': //roadblo ke
				var sky:BGSprite = new BGSprite('BG WOAH/skem bg/sky', -350, -700, 1, 1);
				sky.setGraphicSize(Std.int(sky.width * 0.8));
				sky.updateHitbox();
				add(sky);
				
				var crossraod:BGSprite = new BGSprite('BG WOAH/skem bg/crossroads', -350, -700, 1, 1);
				crossraod.setGraphicSize(Std.int(crossraod.width * 0.8));
				crossraod.updateHitbox();
				add(crossraod);
